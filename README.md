# 🍺 Yet Another Store for Brew

> A modern, premium GUI wrapper for the **Homebrew** (`brew`) package manager.
...
**Yet Another Store for Brew** brings all that CLI power into a stunning, native-feeling graphical user interface. No more forgotten commands, no more syntax errors. Just pure, visual package management.
...
- **Official Website/Repository**: [Homebrew](https://brew.sh)
...
- 🐛 [Report a bug](https://github.com/albertolicea00/yas-brew/issues/new?template=bug_report.md)
- 💡 [Request a feature](https://github.com/albertolicea00/yas-brew/issues/new?template=feature_request.md)

## ⚖️ License & Legal

**Yet Another Store for Brew** is released under the **[MIT License](LICENSE)**.
...
Third-party tools (primarily **Homebrew**) are not bundled and governed by their own licenses.
