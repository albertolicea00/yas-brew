...
QList<CliAction> BrewAdapter::actionCatalog() const
{
    ...
    return {
        ...
        {QStringLiteral("tap-add"), tr("Add tap"),
         tr("Register a third-party repository (user/repo)"),
         {brew, {QStringLiteral("tap")}}, true, false, true},
        {QStringLiteral("untap"), tr("Remove tap"),
         tr("Unregister a third-party repository"),
         {brew, {QStringLiteral("untap")}}, true, true, true},
